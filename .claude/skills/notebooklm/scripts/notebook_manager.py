...
class NotebookLibrary:
    ...
    def add_notebook(
        ...
        print(f"[V] Added notebook: {name} ({notebook_id})")
        return notebook
    ...
    def remove_notebook(self, notebook_id: str) -> bool:
        ...
        if notebook_id in self.notebooks:
            ...
            self._save_library()
            print(f"[V] Removed notebook: {notebook_id}")
            return True
    ...
    def update_notebook(
        ...
        self._save_library()
        print(f"[V] Updated notebook: {notebook['name']}")
        return notebook
    ...
    def select_notebook(self, notebook_id: str) -> Dict[str, Any]:
        ...
        notebook = self.notebooks[notebook_id]
        print(f"[V] Activated notebook: {notebook['name']}")
        return notebook
