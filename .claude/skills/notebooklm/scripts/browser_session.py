...
class BrowserSession:
    ...
    def _initialize(self):
        ...
        try:
            ...
            # (No random_mouse_movement method in BrowserUtils as defined in previous turner, skipping for reliability)
            # self.stealth.random_mouse_movement(self.page)
            self.stealth.random_delay(300, 600)

            print(f"[V] Session {self.id} ready!")
    ...
    def ask(self, question: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"  [V] Got response ({len(answer)} chars)")
    ...
    def reset(self):
        ...
        print(f"[V] Session reset (cleared {previous_count} messages)")
    ...
    def close(self):
        ...
        print(f"[V] Session {self.id} closed")
